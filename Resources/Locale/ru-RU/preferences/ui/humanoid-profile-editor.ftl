...
humanoid-profile-editor-pronouns-label = Личностное местоимение:
...
humanoid-profile-editor-preference-unavailable-stay-in-lobby-button = Остаться в лобби, если выбранные должности недоступны.
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Зайти за {INDEFINITE($overflowJob)} {$overflowJob} если выбранные должности недоступны.
...
humanoid-profile-editor-preference-spawn-priority-arrivals = Станция прибытия
...
humanoid-profile-editor-naming-rules-warning = Осторожно: Оскорбительные или ЛРП имена/описания персонажей могут создать лишние проблемы для вас и для администрации. Прочитайте \[Правила\].
